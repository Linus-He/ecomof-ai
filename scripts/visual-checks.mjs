...
const routes = [
  ["catalysis", "#catalysis", [["Catalysis Cat: Energy Barrier Demo", "催化猫：能垒降低示意"], ["Reaction Pathway Evidence Map", "催化路径证据图"], ["Data Harmonization & Comparability Workflow", "数据整理与可比性评估流程"], ["Organic Acid Workspace", "有机酸路径工作台"]]],
