...
const routes = [
  ...
  ["organic-acid-final", "#catalysis-organic-acid-final-screening", [
    ...
    ["Expanded Database Screening UI", "Expanded Database Screening UI"],
    ["Why in preview?", "为什么进入预览？"],
    ["Candidate Compare", "Candidate Compare"],
    ["Top-N preview only", "Top-N preview only"],
    ["Index Part Browser", "Index Part Browser"],
  ...
  ["methodology", "#methodology", [
    ...
    "V2.0-C",
    ["Database Index Preview", "数据库索引预览"],
    ["Expanded Database Screening UI", "更完整的数据库筛选 UI"],
    ["Candidate Compare", "Candidate Compare"],
