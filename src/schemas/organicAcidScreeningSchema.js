...
export const ORGANIC_ACID_FRAMEWORK_SCHEMA = {
  ...
  fields: [
    ...
    { path: "sourceType", type: "enum", required: true, values: ["core_like_fixture", "manual_seed", "literature_curated"] },
    ...
    { path: "waterStability.sourceStatus", type: "enum", required: true, values: ["verified", "literature_proxy", "pending_metadata", "demo_proxy"] },
    ...
    { path: "mappingStatus", type: "enum", required: true, values: ["mapped_fixture", "needs_review", "blocked"] },
...
export const ELECTRONIC_DESCRIPTOR_SCHEMA = {
  ...
  fields: [
    { path: "candidateId", type: "string", required: true },
    { path: "sourceRecordId", type: "string", required: true },
    { path: "sourceType", type: "enum", required: true, values: ["qmof_like_fixture", "manual_seed", "literature_proxy"] },
...
export const LITERATURE_EVIDENCE_SCHEMA = {
  ...
  fields: [
    ...
    { path: "sourceType", type: "enum", required: true, values: ["uploaded_paper", "previous_uploaded_reference", "manual_note", "method_practice"] },
    { path: "status", type: "enum", required: true, values: ["verified_from_uploaded_file", "pending_metadata", "literature_proxy", "demo_proxy"] },
