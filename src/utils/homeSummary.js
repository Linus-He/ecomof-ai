...
export const DEFAULT_HOME_SUMMARY = Object.freeze({
  ...
  totalRecords: 10277,
  coreMofRecords: 9835,
  fairMofsRecords: 4168,
  fairMofsDoiRecords: 4168,
  fairMofsPorePropertyRecords: 787,
  gasAdsorptionRecords: 442,
  qmofRecords: 0,
  organicAcidLiteratureRecords: 0,
  verifiedMetadataCount: 9835,
  goldDatasetCount: 0,
...
export function buildHomeSummary({ homeSummary, dataIngestionSummary, versionEvolution, projectStatus } = {}) {
  ...
  return {
    ...
    fairMofsRecords: firstNumber(home.fairMofsRecords, DEFAULT_HOME_SUMMARY.fairMofsRecords),
    fairMofsDoiRecords: firstNumber(home.fairMofsDoiRecords, DEFAULT_HOME_SUMMARY.fairMofsDoiRecords),
    fairMofsPorePropertyRecords: firstNumber(home.fairMofsPorePropertyRecords, DEFAULT_HOME_SUMMARY.fairMofsPorePropertyRecords),
    gasAdsorptionRecords: firstNumber(home.gasAdsorptionRecords, home.gasAdsorptionV21?.recordCount, DEFAULT_HOME_SUMMARY.gasAdsorptionRecords),
    ...
    coreMofSourceLabel: firstText(home.coreMofSourceLabel, DEFAULT_HOME_SUMMARY.coreMofSourceLabel),
    structuralSourceStatus: firstText(home.structuralSourceStatus, DEFAULT_HOME_SUMMARY.structuralSourceStatus),
    qmofStatus: firstText(home.qmofStatus, ingestion.availability?.qmof?.status, DEFAULT_HOME_SUMMARY.qmofStatus),
    literatureV33Status: firstText(home.literatureV33Status, ingestion.availability?.literature?.status, DEFAULT_HOME_SUMMARY.literatureV33Status),
