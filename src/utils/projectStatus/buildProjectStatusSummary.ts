...
export const PROJECT_STATUS_ENDPOINTS = Object.freeze({
  ...
  benchmarkReportV2: "data/benchmark_report_v2.json",
  benchmarkDatasetV36: "data/benchmark_dataset_v3_6.json",
  modelCredibilityV2: "data/model_credibility_v2.json",
  modelRobustness: "data/model_robustness_report_v1.json",
  experimentalLabelSummary: "data/experimental_label_summary.json",
