            ...
            <tbody>
              {filtered.map((m, i) => (
                <tr key={m.name} style={{ background: i % 2 === 0 ? "transparent" : t.surface, borderBottom: `1px solid ${t.divider}` }}>
                  ...
                  <td style={{ padding: "10px 14px", color: t.muted, fontSize: 12, fontFamily: FONT_SANS }}>{m.metal}</td>
                  ...
                  <td style={{ padding: "10px 14px", color: t.text, fontSize: 12, fontFamily: FONT_SANS }}>{m.pd}/{m.lcd || "—"}</td>
                  <td style={{ padding: "10px 14px", color: t.text, fontSize: 12, fontFamily: FONT_SANS }}>{Number(m.bet || 0).toLocaleString()} / {m.pv}</td>
                  <td style={{ padding: "10px 14px", fontFamily: FONT_SANS, fontSize: 12, fontWeight: 700, color: m.co2 >= 6 ? t.success : m.co2 >= 3 ? t.accent : t.muted }}>{m.co2}</td>
                  <td style={{ padding: "10px 14px", fontFamily: FONT_SANS, fontSize: 12, color: m.selectivity >= 100 ? t.success : m.selectivity >= 30 ? t.accent : t.muted }}>{m.selectivity}</td>
