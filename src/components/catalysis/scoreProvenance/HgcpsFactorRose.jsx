...
export function HgcpsFactorRose({ model, overlayRoute, lang = "zh", mini = false, withTestId = true, factorDetails = [], factorEvidence = [], selectedFactorKey = "", onSelectFactor }) {
  ...
  return (
    <FactorRoseChart
      ...
      subtitleZh="逐项比较八个数据派生因子；风险保留使用风险色，对照路线以参考标记标出。"
      subtitleEn="Compares the eight data-derived factors; risk retention uses the risk tone and the comparison route is marked by a reference marker."
