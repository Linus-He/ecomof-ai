...
export function SynergyHotSpotMap({ data = [], region = {}, lang, t }) {
  ...
  return (
    <div style={{ display: "grid", gap: 10 }}>
      <svg viewBox="0 0 640 390" role="img" aria-label="Synergy Hot Spot Map" style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: 10, height: "auto", maxWidth: "100%", width: "100%" }}>
        <defs>
