// @ts-nocheck
import { ChemicalText, toolbarBtn } from "../../shared"
      ...
      <div style={{ display: "grid", gap: 5 }}>
        ...
        <p style={{ color: t.muted, fontSize: 12.5, lineHeight: 1.55, margin: 0, maxWidth: 920 }}>
          {zh
            ...
            : <ChemicalText value="Explore organic-acid-oriented CO2 conversion as an independent case workspace with access gate, algorithm tracing, pathway maps, graph reasoning, evidence matrices, and candidate prioritization." />}
        </p>
      </div>
