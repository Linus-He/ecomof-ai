...
export function MissingDataNotice({ message, count = null, t }: any) {
  ...
  return (
    <div data-testid="missing-data-notice" title={APP_VERSION_LABEL} style={{ background: t?.badgeWarnBg || "#FEF3C7", border: `1px solid ${t?.warn || "#B45309"}`, borderRadius: 8, color: t?.warn || "#B45309", fontSize: 11, fontWeight: 700, lineHeight: 1.5, padding: 9 }}>
      {text}
    </div>
  )
}
