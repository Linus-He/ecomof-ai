  ...
  return (
    <section style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: 10, display: "grid", gap: 10, padding: 12 }}>
      <header style={{ display: "grid", gap: 4 }}>
        <strong style={{ color: t.textStrong, fontSize: 14 }}>{text(lang, "Descriptor Availability", "Descriptor Availability")}</strong>
      ...
      <p style={{ color: t.muted, fontSize: 12, lineHeight: 1.5, margin: 0 }}><ChemicalText value={displayValue(availability.interpretation, "Evidence boundary pending")} /></p>
    </section>
  )
}
