...
const DISCLAIMER_SECTIONS = [
  ...
  },
  {
    ...
    titleZh: "催化与机器学习边界",
    bodyEn: "Catalysis organizes reaction tasks, reaction conditions, product metrics, evidence status, and ML-ready fields. It does not claim validated catalytic performance or a trained predictive model.",
    bodyZh: "催化模块用于整理反应任务、反应条件、产物指标、证据状态和面向机器学习的字段，不声称已验证催化性能，也不声称已有训练好的预测模型。",
