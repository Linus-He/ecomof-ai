...
const formulaDetails = {
  ...
  "evidence-confidence": {
    ...
    interpretationZh: "当描述符溯源不完整、验证等级较低或关键字段缺少来源时，Q 会降低候选物的期望评分，避免低证据记录进入排序前列。",
  ...
  "candidate-priority-score": {
    ...
    interpretationZh: "候选排序综合反映验证优先顺序、数据补充需求和对照材料适用性，不等同于单一性能排名。",
    ...
    outputsZh: "候选物在排序矩阵中的位置和下一步验证动作。",
