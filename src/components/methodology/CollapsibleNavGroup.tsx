  ...
  return (
    <div style={{ alignContent: "start", display: "grid", gap: 4, minWidth: 0 }}>
      <button
        ...
        style={{
          alignItems: "center",
          background: active ? `color-mix(in srgb, ${t.textStrong} 7%, ${t.panel})` : t.surface,
          border: 0,
          borderRadius: 6,
          ...
          {item.children.map(child => {
            ...
            return (
              <button
                ...
                style={{
                  background: childActive ? `color-mix(in srgb, ${t.textStrong} 7%, ${t.panel})` : "transparent",
                  border: 0,
                  borderRadius: 6,
                  color: childActive ? t.accentText : t.muted,
                  cursor: "pointer",
                  fontSize: 11.3,
                  fontWeight: childActive ? 750 : 550,
                  lineHeight: 1.28,
                  padding: "6px 8px",
                  textAlign: "left",
                  whiteSpace: "normal",
