...
export function VersionStatusBadge({ status, t }) {
  ...
  return (
    <span style={{ background: palette[0], border: `1px solid ${palette[1]}`, borderRadius: 999, color: palette[1], display: "inline-flex", fontSize: 10.5, fontWeight: 900, lineHeight: 1.1, padding: "5px 8px", textTransform: "uppercase" }}>
