...
export function MethodologyLimitationsCard({ lang, t }) {
  ...
  const reproducibility = [
    ...
    [text(lang, "敏感性脚本将公开。", "Sensitivity scripts will be public.")],
    [text(lang, "保留候选级 provenance。", "Candidate-level provenance retained.")],
  ]
  ...
  return (
    <section id="methodology-oafs-limitations" style={{ background: t.panel, border: `1px solid ${t.border}`, borderRadius: 12, display: "grid", gap: 13, padding: 15, scrollMarginTop: 118 }}>
      ...
      <div style={{ display: "grid", gap: 10, gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
        {[
          [text(lang, "Limitations", "Limitations"), limitations, t.badgeWarnBg, t.warn],
          [text(lang, "Reproducibility", "Reproducibility"), reproducibility, t.badgeInfoBg, t.accentText],
