...
export const DATA_SOURCE_REGISTRY: DataSourceEntry[] = [
  ...
  { id: "mof-physicochemical-crosswalk", name: "CoRE MOF 2024 physicochemical layer with FAIR-MOFs exact-Refcode cross-validation", category: "MOF", datasetType: "provenance_records", dataMode: "mixed", path: "data/mof_physicochemical_index_v1.json", recordKey: "records", hasProvenance: true, participatesIn: ["ecoScreen", "mofLibrary", "researchReports", "export"], updatedAt: "2026-07-29" },
  { id: "mof-anatomy-identity", name: "MOF Anatomy factual identity and literature pointers", category: "MOF", datasetType: "provenance_records", dataMode: "literature", path: "data/mof_anatomy_identity_index_v1.json", recordKey: "records", hasProvenance: true, participatesIn: ["mofLibrary", "researchReports"], updatedAt: "2026-07-29" },
  ...
  { id: "gas-molecular-properties", name: "Gas molecular properties and database backfill targets", category: "GasSep", datasetType: "provenance_records", dataMode: "literature", path: "data/gas_molecular_properties_v1.json", recordKey: "gases", hasProvenance: true, participatesIn: ["gasSep", "researchReports", "export"], updatedAt: "2026-08-01" },
