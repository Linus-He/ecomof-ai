...
describe("home capabilities", () => {
  it("highlights platform capabilities, data foundation, validation, and research scenarios", () => {
    ...
    expect(within(capabilities).getByText("数据层")).toBeInTheDocument()
    ...
    expect(within(capabilities).getByText("EcoScreen")).toBeInTheDocument()
    expect(within(capabilities).getByText("Performance Priority")).toBeInTheDocument()
    expect(within(capabilities).getByText("Ranking Explanation")).toBeInTheDocument()
    expect(within(capabilities).getByText("Reaction Dataset")).toBeInTheDocument()
    expect(within(capabilities).getByText("Evidence Graph")).toBeInTheDocument()
    expect(within(capabilities).getByText("Decision Board")).toBeInTheDocument()
    expect(within(capabilities).getByText("Experimental Labels")).toBeInTheDocument()
    expect(within(capabilities).getByText("Benchmark")).toBeInTheDocument()
    expect(within(capabilities).getByText("Model Validation")).toBeInTheDocument()
