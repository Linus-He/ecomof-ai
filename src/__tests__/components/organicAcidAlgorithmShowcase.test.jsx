...
describe("Organic Acid AlgorithmShowcaseSection", () => {
  it("renders the eight-factor formula, descriptor matrix, preregistration, and audit conclusions", () => {
    ...
    expect(screen.getByTestId("algorithm-showcase-section").textContent).toMatch(/voidFraction/)
    expect(screen.getByTestId("algorithm-showcase-section").textContent).toMatch(/MIL-type host/)
  })
})
